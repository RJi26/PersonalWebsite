<template>
  <div class="bizScene">
    <TitleSection scene="bizTitle">
      <TitleFunction params="2021,Present">biz</TitleFunction>
    </TitleSection>
    ...
    <SceneSection id="biz1">
      <TextBlock>
        <p class="-big">
          In 2023, I created 
          <strong class="-purple">PankVision 3D</strong>
          @
          <a
            href="https://github.com/RJi26/PankVision-3D"
            target="_blank"
            title="Visit it's github"
          >
            info</a
          >.
        </p>
        <p>
          An automatic pancreas detection tool using AI designed towards the optimization of real-time pancreas tracking during radiotherapy.
        </p>
      </TextBlock>
      <template #container>
    ...
    <SceneSection id="biz2">
      <TextBlock>
        <p>
          I’ve participated in numerous projects and competitions over the years, focusing on
          <span class="-big -purple">
            AI, Web Development, Datascience, and Cybersecurity 
          </span>
    ...
    <SceneSection id="biz3">
      <TextBlock>
        <p>
          ...
          <span class="-big">
            <span class="-purple">Brain Tumour Growth</span>, focusing on how AI can be 
            utilized to
            <span class="-purple">automate the process</span> efficiently.
          </span>
        </p>
      </TextBlock>
    </SceneSection>
